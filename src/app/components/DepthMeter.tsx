...
const depthZones = [
  ...
  { label: 'Sunlight', emoji: '☀️', depth: 0.15, meters: '200m' },
  { label: 'Twilight', emoji: '🐋', depth: 0.35, meters: '1000m' },
  { label: 'Midnight', emoji: '🦑', depth: 0.55, meters: '4000m' },
  { label: 'Abyssal', emoji: '🐙', depth: 0.75, meters: '6000m' },
  ...
  return (
    <div className="fixed right-5 top-1/2 -translate-y-1/2 z-40 hidden lg:flex items-center gap-3">
      ...
      <div className="relative flex flex-col items-center">
        <div className="relative w-[3px] h-52 bg-[#6A89A7]/10 rounded-full overflow-hidden">
          <motion.div
